...
import { CountryGroupTable } from '@/src/db/product';
...
export async function updateCountryGroup() {
    const countrydata = country.map(({ name, recommendedDiscountPercentage }) => {
...
export async function updateCountry() {
    ...
    const data = await country.flatMap(({ countries, name }) => {
